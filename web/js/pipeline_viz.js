...
const ICONS = {
  ...
  temas: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75"><circle cx="7" cy="7" r="3.5"/><circle cx="17" cy="7" r="3.5"/><circle cx="12" cy="17" r="3.5"/></svg>`,
...
const ETAPAS = [
  ...
  { id: "temas", label: "Temas", sub: "LDA · coseno", flechaDespues: true },
